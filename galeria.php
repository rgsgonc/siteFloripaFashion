	...
	<!--start-header-->
			<div id="home" class="header two">
			    ...
			    <div class="banner two">
				      <div class="container">
					     <h2 class="second-tittle">Portfolio</h2>
				      </div>
				</div>
           </div>
		<!--start-portfolio-->
		...
		<div class="container">
				...
				<div class="gallery-1">
					<div class="col-md-3 gallery-grid">
						<a class="example-image-link" href="images/n2.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="images/n2.jpg" alt=""/></a>
					</div>
					<div class="col-md-3 gallery-grid">
					...
					<div class="col-md-3 gallery-grid">
						<a class="example-image-link" href="images/g7.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="images/g4.jpg" alt=""/></a>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="gallery-1">
				...
				<div class="gallery-1">
					...
					<div class="col-md-3 gallery-grid">
						<a class="example-image-link" href="images/n3.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="images/n3.jpg" alt=""/></a>
					</div>
					<div class="col-md-3 gallery-grid">
						<a class="example-image-link" href="images/n2.jpg" data-lightbox="example-set" data-title="Click the right half of the image to move forward."><img class="example-image" src="images/n2.jpg" alt=""/></a>
					</div>
